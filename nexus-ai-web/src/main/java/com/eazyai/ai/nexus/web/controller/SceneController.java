...
public class SceneController {
    ...
    public ResponseEntity<SceneDescriptor> getScene(@PathVariable("sceneId") String sceneId) {
    ...
    public ResponseEntity<List<SceneDescriptor>> getScenesByApp(@PathVariable("appId") String appId) {
    ...
    public ResponseEntity<List<SceneDescriptor>> getScenesByType(@PathVariable("type") String type) {
    ...
    public ResponseEntity<Void> deleteScene(@PathVariable("sceneId") String sceneId) {
